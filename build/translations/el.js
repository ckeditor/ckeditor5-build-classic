(function(d) {
	d["el"] = Object.assign(d["el"] || {}, {
		...
		bk: "Επανάληψη",
		bl: "Editor toolbar",
		bm: "Επεξεργαστής Πλούσιου Κειμένου, 0%",
		bn: "Επεξεργαστής Πλούσιου Κειμένου",
		bo: "Dropdown toolbar",
		bp: "%0 of %1",
		bq: "Previous",
		br: "Next",
		bs: "Αλλαγή εναλλακτικού κείμενου",
		bt: "Παράγραφος",
		bu: "Κεφαλίδα 1",
		bv: "Κεφαλίδα 2",
		bw: "Κεφαλίδα 3",
